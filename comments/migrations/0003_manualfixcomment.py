# Generated by Django 3.0.5 on 2020-06-08 21:47
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('comments', '0002_techtipcomment'),
    ]

    operations = [
        migrations.CreateModel(
            name='ManualFixComment',
            fields=[
                ...
                ('manual_fix', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='resolutions.TechTipFix')),
            ],
        ),
    ]
